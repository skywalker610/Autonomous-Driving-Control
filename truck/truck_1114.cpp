//0918 mx 0924 pz 0928 mx (pure pursuit)
...
int simulation_mode = 1; //-------------------------------------------------->  choose mode here! 0:experiments; 1:simulation - 0918 mx
...
void gnssCallback(const std_msgs::Float32MultiArray::ConstPtr& msg)
{
...
int main ( int argc, char**argv){
	...
	int wps_wdw_num = 10; //  window ahead with wps_idx
	...
	while(ros::ok()){
		...
		switch(str_ctrl_mode){
			...
			case 0: // 3pts curv pid
				...
				str_step_ref = MKZ_model_r2str(r);
				str_step = str_step_ref + Kp*offset_ctrl + Kd*d_offset;
				cout << "r=" << r << "; d_o2v=" << d_o2v << "; offset=" << offset_ctrl << "; d_offset=" << d_offset << "\n";
				cout << "str_step_ref=" << str_step_ref << "; str_step=" << str_step << "\n";
			...
			case 1: // 2pts straight pid
				...
				str_step_ref = 0;
				str_step = str_step_ref + Kp*offset_ctrl + Kd*d_offset;
				cout << "offset=" << offset_ctrl << "; str_step=" << str_step << "\n";
				break;
				}
			...
			case 2:// udacity MPC
				...
				vector<double> ptsx {wps_x[wps_wdw[wps_wdw_idx]], wps_x[wps_wdw[wps_wdw_idx+1]], wps_x[wps_wdw[wps_wdw_idx+2]], wps_x[wps_wdw[wps_wdw_idx+3]], wps_x[wps_wdw[wps_wdw_idx+4]], wps_x[wps_wdw[wps_wdw_idx+5]]};
				vector<double> ptsy {wps_y[wps_wdw[wps_wdw_idx]], wps_y[wps_wdw[wps_wdw_idx+1]], wps_y[wps_wdw[wps_wdw_idx+2]], wps_y[wps_wdw[wps_wdw_idx+3]], wps_y[wps_wdw[wps_wdw_idx+4]], wps_y[wps_wdw[wps_wdw_idx+5]]};
		...
		// str_cmd	= -str_step; // use neg sign to match mbed
		str_cmd	= -str_step; // 0828 larger steering angle
		...
		//string hex;
		//hex = printf("%02hhx%02hhx",char(str_cmd_string[0]),char(str_cmd_string[1]));
		//cout <<"\n";

		//hex = "%0.2X" % str_cmd_string[0];
		...
		//std::string str_cmd_string = std::to_string(str_cmd_int);
		//cout << "str_cmd_string  =" << str_cmd_string << "\n";


		//char buffer[2];
		//sprintf(buffer, "%d", str_cmd_int);
		//cout << "str_cmd_string [0] =" << buffer[0] << "\n";
		//cout << "str_cmd_string [1] =" << buffer[1] << "\n";
		//cout << "str_cmd_string [2] =" << buffer[2] << "\n";
		//cout << "str_cmd_string [3] =" << buffer[3] << "\n";
		...
		// publish trajectory: visualization_msgs::Marker::LINE_STRIP ====================================================
		...
		refer.scale.y = 0.5;
		refer.scale.z = 0.5;
		refer.color.r = 1.0; //red
		refer.color.g = 0.0; //green
		refer.color.a = 1;
		if(str_ctrl_mode == 2){
		...
		reference_trajectory_fitting.scale.x = 0.2;// LINE_STRIP/LINE_LIST markers use only the x component of scale, for the line width
		reference_trajectory_fitting.color.r = 0.0; //red
		reference_trajectory_fitting.color.g = 1.0; //green
		reference_trajectory_fitting.color.a = 1.0;
