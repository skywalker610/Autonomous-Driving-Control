// Generated by gencpp from file gps_common_msgs/GPSStatus.msg
// DO NOT EDIT!


#ifndef GPS_COMMON_MSGS_MESSAGE_GPSSTATUS_H
#define GPS_COMMON_MSGS_MESSAGE_GPSSTATUS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::gps_common_msgs::GPSStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gps_common_msgs::GPSStatus_<ContainerAllocator> const> ConstPtr;

}; // struct GPSStatus_

typedef ::gps_common_msgs::GPSStatus_<std::allocator<void> > GPSStatus;

typedef boost::shared_ptr< ::gps_common_msgs::GPSStatus > GPSStatusPtr;
typedef boost::shared_ptr< ::gps_common_msgs::GPSStatus const> GPSStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gps_common_msgs::GPSStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gps_common_msgs::GPSStatus_<ContainerAllocator1> & lhs, const ::gps_common_msgs::GPSStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gps_common_msgs::GPSStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_common_msgs::GPSStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_common_msgs::GPSStatus_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gps_common_msgs::GPSStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x313baa8951fdd056ULL;
  static const uint64_t static_value2 = 0xc78bf61b1b07d249ULL;
};

template<class ContainerAllocator>
struct DataType< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gps_common_msgs::GPSStatus_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // GPS_COMMON_MSGS_MESSAGE_GPSSTATUS_H
