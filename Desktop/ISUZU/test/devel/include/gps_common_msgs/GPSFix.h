// Generated by gencpp from file gps_common_msgs/GPSFix.msg
// DO NOT EDIT!


#ifndef GPS_COMMON_MSGS_MESSAGE_GPSFIX_H
#define GPS_COMMON_MSGS_MESSAGE_GPSFIX_H
...
#include <gps_common_msgs/GPSStatus.h>

namespace gps_common_msgs
{
...
struct GPSFix_
{
  ...
  _header_type header;
   ...
   typedef  ::gps_common_msgs::GPSStatus_<ContainerAllocator>  _status_type;
  _status_type status;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::gps_common_msgs::GPSFix_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gps_common_msgs::GPSFix_<ContainerAllocator> const> ConstPtr;

}; // struct GPSFix_

typedef ::gps_common_msgs::GPSFix_<std::allocator<void> > GPSFix;

typedef boost::shared_ptr< ::gps_common_msgs::GPSFix > GPSFixPtr;
typedef boost::shared_ptr< ::gps_common_msgs::GPSFix const> GPSFixConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gps_common_msgs::GPSFix_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gps_common_msgs::GPSFix_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gps_common_msgs::GPSFix_<ContainerAllocator1> & lhs, const ::gps_common_msgs::GPSFix_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gps_common_msgs::GPSFix_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_common_msgs::GPSFix_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_common_msgs::GPSFix_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gps_common_msgs::GPSFix_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3db3d0a7bc53054cULL;
  static const uint64_t static_value2 = 0x67c528af84710b70ULL;
};

template<class ContainerAllocator>
struct DataType< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gps_common_msgs::GPSFix_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gps_common_msgs::GPSFix_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "status: ";
    s << std::endl;
    Printer< ::gps_common_msgs::GPSStatus_<ContainerAllocator> >::stream(s, indent + "  ", v.status);
    s << indent << "latitude: ";
...
#endif // GPS_COMMON_MSGS_MESSAGE_GPSFIX_H
