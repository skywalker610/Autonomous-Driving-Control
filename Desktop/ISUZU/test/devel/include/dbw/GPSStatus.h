// Generated by gencpp from file dbw/GPSStatus.msg
// DO NOT EDIT!


#ifndef DBW_MESSAGE_GPSSTATUS_H
#define DBW_MESSAGE_GPSSTATUS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::dbw::GPSStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw::GPSStatus_<ContainerAllocator> const> ConstPtr;

}; // struct GPSStatus_

typedef ::dbw::GPSStatus_<std::allocator<void> > GPSStatus;

typedef boost::shared_ptr< ::dbw::GPSStatus > GPSStatusPtr;
typedef boost::shared_ptr< ::dbw::GPSStatus const> GPSStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw::GPSStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw::GPSStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dbw::GPSStatus_<ContainerAllocator1> & lhs, const ::dbw::GPSStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::dbw::GPSStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dbw::GPSStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw::GPSStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw::GPSStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw::GPSStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw::GPSStatus_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw::GPSStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dbw::GPSStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x313baa8951fdd056ULL;
  static const uint64_t static_value2 = 0xc78bf61b1b07d249ULL;
};

template<class ContainerAllocator>
struct DataType< ::dbw::GPSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dbw::GPSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw::GPSStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw::GPSStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw::GPSStatus_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
