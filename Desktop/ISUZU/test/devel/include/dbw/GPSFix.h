// Generated by gencpp from file dbw/GPSFix.msg
// DO NOT EDIT!


#ifndef DBW_MESSAGE_GPSFIX_H
#define DBW_MESSAGE_GPSFIX_H
...
struct GPSFix_
{
  ...
  _header_type header;
   ...
   typedef  ::dbw::GPSStatus_<ContainerAllocator>  _status_type;
  _status_type status;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::dbw::GPSFix_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dbw::GPSFix_<ContainerAllocator> const> ConstPtr;

}; // struct GPSFix_

typedef ::dbw::GPSFix_<std::allocator<void> > GPSFix;

typedef boost::shared_ptr< ::dbw::GPSFix > GPSFixPtr;
typedef boost::shared_ptr< ::dbw::GPSFix const> GPSFixConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dbw::GPSFix_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dbw::GPSFix_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dbw::GPSFix_<ContainerAllocator1> & lhs, const ::dbw::GPSFix_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::dbw::GPSFix_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dbw::GPSFix_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw::GPSFix_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dbw::GPSFix_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw::GPSFix_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dbw::GPSFix_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dbw::GPSFix_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dbw::GPSFix_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3db3d0a7bc53054cULL;
  static const uint64_t static_value2 = 0x67c528af84710b70ULL;
};

template<class ContainerAllocator>
struct DataType< ::dbw::GPSFix_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dbw/GPSFix";
...
template<class ContainerAllocator>
struct Definition< ::dbw::GPSFix_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dbw::GPSFix_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dbw::GPSFix_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dbw::GPSFix_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "status: ";
    s << std::endl;
    Printer< ::dbw::GPSStatus_<ContainerAllocator> >::stream(s, indent + "  ", v.status);
    s << indent << "latitude: ";
