...
size_t N = 16; // default value 16
double dt = 0.1; //default 0.1
...
const double Lf = 2.76;

// Ref speed
const double ref_v = 3; // 0.89m/s = 2mph
const double ref_cte = 0.0; // want cte = 0
const double ref_epsi = 0.0; // want the angle differnece = 0
int latency_steps = 0/dt; // default: 0.2/dt
...
protected:
    void buildCostFunc(ADvector& fg, const ADvector& vars)
    {
      ...
      /* weights tuning */
      static const double weight_cte = 8;//----------------------------------------------------------------------------> weights!
      static const double weight_epsi = 1;
      static const double weight_v = 1;
      static const double weight_steering = 50;   // lower weight_steering, more aggresive steer
